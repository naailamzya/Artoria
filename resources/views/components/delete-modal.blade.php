@props(['title' => 'Confirm Deletion', 'message' => 'Are you sure you want to delete this item? This action cannot be undone.', 'action' => '#'])

<div x-data="{ show: false }" 
     @delete-modal.window="show = true"
     x-show="show"
     x-cloak
    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div x-show="show" 
            ...
            <div class="p-6">
                <div class="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-red-500/20 border border-red-500/50">
                ...
                <div class="mt-6 flex flex-col sm:flex-row-reverse gap-3">
                    <form :action="$event.target.dataset.action" method="POST" class="flex-1">
                        @csrf
                        @method('DELETE')
                        <button type="submit" 
